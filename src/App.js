...
import SidebarRoomIds from "../src/Sidebar/SidebarRoomIds";
...
var timer = Math.floor(new Date().getTime()/1000);
  useEffect(() => {
      ...
      if (authUser) {
        ...
        if (authUser.isAnonymous === true && authUser.displayName === null) {
          ...
          db.collection("rooms")
            ...
            .set({
              name: anonymousName,
              about: "Hey there! I am using UberClone.",
              photoURL: "",
              role: "anonymous",
          ...
          db.collection("rooms")
            ...
            .then(function (doc) {
              if (doc.exists) {
                ...
                db.collection("rooms").doc(authUser.uid).set({
              ...
              <Router>
                <Switch>
                 ...
                 />*/}
                  ...
                  <Route exact path="/roomsusers/:roomId">
                    <Hidden only={["xs"]}>
                      {" "}
                      {/* Sidebar component will be hidden in mobile view */}
                      <Sidebar
